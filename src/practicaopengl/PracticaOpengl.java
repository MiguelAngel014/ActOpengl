 ...
 * @author itoan
 */
public class PracticaOpengl extends GLJPanel implements GLEventListener, KeyListener {
   // Define constants for the top-level container
   private static String TITLE = "Gorra";  // window's title
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         ...
         public void run() {
            ...
            GLJPanel canvas = new PracticaOpengl();
   ...
   public void init(GLAutoDrawable drawable) {
      ...
      this.textura1 = this.cargarTextura("imagenes/Viejas.jpg");
